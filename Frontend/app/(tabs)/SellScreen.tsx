          ...
          >
            ...
            {currentStep === 1 && (
              <>
                ...
                {/* Product Quantity */}
                <View style={styles.field}>
                  <FieldLabel label="Product Quantity" required theme={theme} />

                  <View style={styles.quantityContainer }>
                    <TouchableOpacity
                      style={[styles.qtyButton, {  backgroundColor: theme.subText,}]}
                      onPress={() =>
                        setProductQuantity(
                          Math.max(0, Number(quantity) - 1)
                        )
                      }
                    >
                    ...
                    <TextInput
                      ...
                      onChangeText={(text) => {
                        ...
                        setProductQuantity(cleaned ? Number(cleaned) : 0);
                      }}
                      style={[styles.quantityInput, {borderColor: isDark ? "#334155" : "#E2E8F0", backgroundColor: theme.sectionBackground , color: theme.text}]}
                    />

                    <TouchableOpacity
                      style={[styles.qtyButton, {  backgroundColor: theme.subText,}]}
                      onPress={() =>
                        setProductQuantity((Number(quantity || 0) + 1))
                      }
                    >
                      <Text style={styles.qtyText}>+</Text>
                    </TouchableOpacity>
