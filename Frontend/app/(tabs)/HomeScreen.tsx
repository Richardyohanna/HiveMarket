...
import CategorySection from '../HomeScreen/CategorySection';
import FeaturedProductSection from '../HomeScreen/FeaturedProductSection';
import HeaderSection from '../HomeScreen/HeaderSection';
            ...
            return (
              <Pressable
                ...
                onPress={() => {
                  setActiveFilter(f);
                  if (f !== "All") {
                    router.push({ pathname: "/CategoryScreen", params: { cat: f.toLowerCase() } });
                  }
                }}
                style={[
                  styles.chip,
