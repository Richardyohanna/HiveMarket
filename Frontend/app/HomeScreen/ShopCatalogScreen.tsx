import { BLOCKS_BEFORE_REFETCH, Colors, FETCH_COOLDOWN_MS, FontSize, PRIMARY, PRODUCTS_PER_BLOCK } from "@/constants/theme";
import { increaseProductViewApi } from "@/src/api/productApi";
import { useShopStore } from "@/src/hooks/useShopStore";
...
const ShopCatalogScreen = () => {
  ...
  const { products , loading: storeLoading } = useShopStore(user.id, shopId); 
  ...
  console.log("Products:", fresh.length);
...
export default ShopCatalogScreen;
