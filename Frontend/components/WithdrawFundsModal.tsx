  ...
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={handleClose}>
        ...
        <View style={[styles.content, { backgroundColor: theme.background }]}>
          {step === 'amount' && (
            <>
              ...
              <Text style={[styles.subtitle, { color: theme.readColor }]}>Available Balance: ₦{balance.toFixed(2)}</Text>
              <TextInput
          ...
          {step === 'bank' && (
            <>
              ...
              <Text style={[styles.subtitle, { color: theme.readColor }]}>Withdrawing ₦{parseFloat(amount).toFixed(2)}</Text>
              ...
              >
                <Text style={{ color: selectedBank ? theme.text : theme.readColor }}>{selectedBank ? selectedBank.name : 'Select bank'}</Text>
              </Pressable>
              ...
              {resolving && (
                <View style={styles.statusRow}>
                  ...
                  <Text style={[styles.statusText, { color: theme.readColor }]}>Verifying account...</Text>
                </View>
              )}
              {resolvedName && (
      ...
      <Modal visible={showBankPicker} transparent animationType="slide">
        <View style={styles.overlay}>
          <View style={[styles.content, { backgroundColor: theme.background, maxHeight: '70%' }]}>
